...
def checkPosition(all_peaks):
    try:
        ...
        if (f):
            degrees = 180 - degrees
        if (degrees<70):
            print("Spine: Hunchback")
            print("Spine: Angle", degrees,"°")
            cpos=90-degrees
            print("Correct your posture by moving back", cpos,"°")
        elif (degrees > 110):
            print("Spine: Reclined")
            print("Spine: Angle", degrees,"°")
            cpos1=degrees-90
            print("Correct your posture by moving forward", cpos1,"°")
        else:
            print("Spine: Straight")
            print("Spine: Angle", degrees,"°")
            print("Good Posture")
...
def checkKneeling(all_peaks):
    ...
    try:
        ...
        if (leftdegrees > 60  and rightdegrees > 60): # 60 degrees is trail and error value here. We can tweak this accordingly and results will vary.
            print ("Legs: Both Legs are in Kneeling")
            print("Left Angle", leftdegrees,"°")
            print("Right Angle", rightdegrees,"°")
        elif (rightdegrees > 60):
            print ("Legs: Right leg is kneeling")
            print("Left Angle", leftdegrees,"°")
            print("Right Angle", rightdegrees,"°")
        elif (leftdegrees > 60):
            print ("Legs: Left leg is kneeling")
            print("Legs: Left Angle", leftdegrees,"°")
            print("Legs: Right Angle", rightdegrees,"°")
        else:
            print ("Legs: Not kneeling")
            print("Legs: Left Angle", leftdegrees,"°")
            print("Legs: Right Angle", rightdegrees,"°")
        ...
        try:
            if (f):
                ...
                a = all_peaks[13][0][0:2] # if only one (left leg) is detected
            ...
            if (f == 0):
                degrees = 180 - degrees
            if (degrees > 60):
                print ("Legs: Both Legs Kneeling")
                print("Angle", degrees,"°")
            else:
                print("Legs: Not Kneeling")
                print("Legs: Angle", degrees,"°")
        except Exception as e:
